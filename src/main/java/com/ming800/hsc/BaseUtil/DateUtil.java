...
public class DateUtil {
    ...
    private static SimpleDateFormat simpleformat = new SimpleDateFormat(
            "yyyy年M月d日 E", Locale.CHINA);
    private static SimpleDateFormat dateFormatSimple = new SimpleDateFormat(
            "yyyyMMdd", Locale.US);
    private static SimpleDateFormat dateMinuteFormat = new SimpleDateFormat(
            "HH:mm", Locale.US);
            ...
            if (monthC1 == monthC2) {
                ...
                if (dayC1 == dayC2) {
                    ...
                    if (hourC1 == hourC2) {
                        ...
                        int minuteC2 = c2.get(Calendar.MINUTE);
                        if (minuteC1 == minuteC2) {
                            int secondC1 = c1.get(Calendar.SECOND);
                            int secondC2 = c2.get(Calendar.SECOND);
    ...
    public static String formatMinute(final Date date) {
        return dateMinuteFormat.format(date);
    }

    public static String formatDateMonthDay(final Date date) {
        return dateFormatMonthDay.format(date);
    }

    public static String formatYRDate(final Date date) {
        return YRAndWeekFormat.format(date);
    }

    public static String formatDateWeek(final Date date) {
        return dateAndWeekFormat.format(date);
    }

    public static String formatDateSimply(final Date date) {
    ...
    public static Date getMondayOfCurrentWeek() throws ParseException {

        String tempTime = dateFormat.format(new Date()) + " 00:00:00";

        Calendar calendar = Calendar.getInstance();
        calendar.setTime(datetimeFormat.parse(tempTime));
    ...
    public static Date getSundayOfCurrentWeek() throws ParseException {

        String tempTime = dateFormat.format(new Date()) + " 23:59:59";
