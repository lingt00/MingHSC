            ...
            <div class="nva-panel nva-hidden container content-first" style="padding-left:0;padding-right:0;margin-top:20px;">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td style="width:80px; "><a data-ajax="true" data-inline="true" data-transition="slide"  class="ui-btn ui-icon-bullets ui-btn-icon-left" href="<c:url value="/stu/jb/MsgDetail.do"/>">详细</a> </td>
                    </tr>
                    <tr>
                        <td>出勤</td>
                        <td> 小明:2014-06-22 英语课堂第一课时 考勤成功!剩余课时21.</td>
                        <td ><a data-ajax="false" data-inline="true" data-transition="slide" class="ui-btn ui-icon-bullets ui-btn-icon-left" href="<c:url value="/stu/jb/List.do"/>" >详细</a> </td>
                    </tr>
                    <tr>
                        <td>公告</td>
                        <td>明天放假</td>
